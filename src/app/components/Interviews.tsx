...
interface Video { id: string; url: string; title: string; description: string; }

const videos: Video[] = [
  { id: "YnsnAwQaZhM", url: "https://youtu.be/YnsnAwQaZhM", title: "Cultural Spotlight",  description: "Exploring the intersection of tradition and modernity" },
  { id: "zHtjLi-8_sc", url: "https://youtu.be/zHtjLi-8_sc", title: "Innovation Story",    description: "Voices of African tech pioneers"                     },
  { id: "jf2N-WFeEGQ", url: "https://youtu.be/jf2N-WFeEGQ", title: "Creative Journey",    description: "Behind the scenes with African creators"              },
  { id: "s_hkkJJSU54", url: "https://youtu.be/s_hkkJJSU54", title: "Community Impact",    description: "Stories of change and transformation"                 },
];
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-between p-6">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <motion.div initial={{ scale: 1 }} animate={{ scale: isHovered ? 1.1 : 1 }} transition={{ duration: 0.3 }}
