...
function VideoCard({ video, index }: { video: Video; index: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Gradient overlay — stronger at bottom to protect text */}
      ...
      {/* ── Bottom content block: play button + text, always together ── */}
      <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 md:p-6">
        {/*
          Layout: play button on the left, text on the right.
          This keeps the button visually anchored to the content it
          represents and completely eliminates any overlap with text.
        */}
        <div className="flex items-end gap-3 sm:gap-4">

          {/* Play button — left-aligned, sized to match text block height */}
          <motion.a
            href={video.url}
            target="_blank"
            rel="noopener noreferrer"
